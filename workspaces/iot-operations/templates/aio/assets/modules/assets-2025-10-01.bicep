// assets-2025-10-01.bicep
// -------------------------------------------------------------------------------------
// Every asset catalog resource kind, written at the 2025-10-01 ADR API generation.
//
...
resource deviceResources 'Microsoft.DeviceRegistry/namespaces/devices@2025-10-01' = [
...
resource assetResources 'Microsoft.DeviceRegistry/namespaces/assets@2025-10-01' = [
  for asset in assets: {
    parent: adrNamespace
    name: asset.name
    location: location
