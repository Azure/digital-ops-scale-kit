// main.bicep
// -------------------------------------------------------------------------------------
// Family entry point for the dataflow catalog. Creates every dataflow resource kind the
// effective composition carries, at the AIO API generation the site's release ships.
//
