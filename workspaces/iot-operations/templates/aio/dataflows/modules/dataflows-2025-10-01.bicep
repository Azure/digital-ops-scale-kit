// dataflows-2025-10-01.bicep
// -------------------------------------------------------------------------------------
// Every dataflow resource kind, written at the 2025-10-01 AIO API generation.
//
...
resource endpoints 'Microsoft.IoTOperations/instances/dataflowEndpoints@2025-10-01' = [
...
resource profiles 'Microsoft.IoTOperations/instances/dataflowProfiles@2025-10-01' = [
...
resource dataflowResources 'Microsoft.IoTOperations/instances/dataflowProfiles/dataflows@2025-10-01' = [
...
output deployedApiVersion string = '2025-10-01'
