...
| `aio-releases/` | Release pinning. One YAML per AIO release (e.g. `2607.yaml`) with the API and extension versions for that release. The site's `properties.aioRelease` selects which file is loaded. |
