...
| `aio-releases/` | Release pinning. One YAML per AIO release (e.g. `2606.yaml`) with the API and extension versions for that release. The site's `properties.aioRelease` selects which file is loaded. |
